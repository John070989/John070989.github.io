/*! jQuery v3.1.1 | (c) jQuery Foundation | jquery.org/license */ !function(a, b) {
    ...
    var x = function(a) {
        ...
        }, W = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $1 = /[+~]/, _ = new RegExp("\\\\([\\da-f]{1,6}" + K + "?|(" + K + ")|.)", "ig"), aa = function(a, b, c) {
            var d = "0x" + b - 65536;
            ...
            if (!e && ((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, p)) {
                ...
                if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
                    if (1 !== w) s = b, r = a;
                        ...
                        r = o.join(","), s = $1.test(a) && qa(b.parentNode) || b;
                    }
                    if (r) try {
        ...
        return h = ga.compile = function(a, b) {
            ...
            if (c = c || [], 1 === n.length) {
                ...
                while(f--){
                    ...
                    if ((l = d.find[k]) && (e = l(j.matches[0].replace(_, aa), $1.test(i[0].type) && qa(b.parentNode) || b))) {
                        if (i.splice(f, 1), a = e.length && sa(i), !a) return G.apply(c, e), c;
                        break;
                    }
                }
            }
            return (m || h(a, n))(e, b, !p, c, !b || $1.test(a) && qa(b.parentNode) || b), c;
        ...
        data: function(a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = W.get(f), 1 === f.nodeType && !V.get(f, "hasDataAttrs"))) {
                    c = g.length;
                    while(c--)g[c] && (d = g[c].name, 0 === d.indexOf("data-") && (d = r.camelCase(d.slice(5)), $1(f, d, e[d])));
...
$(".sidenav").click(function() {
    $(this).toggleClass("active"), $(".sidenav__dropdown").toggleClass("sidenav__dropdown_active");
});
